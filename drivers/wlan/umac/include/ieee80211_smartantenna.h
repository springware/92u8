...
#define RETRAIN_INTERVEL 30000  /* 2 minutes */
...
/* State Variable */
#define SMARTANTENNA_TRAIN_NOTDONE 0x00
#define SMARTANTENNA_TRAIN_INPROGRESS 0x01
#define SMARTANTENNA_TRAIN_MOVE_NEXTRATE 0x02
#define SMARTANTENNA_TRAIN_DONE 0x03
#define SMARTANTENNA_NODE_BAD 0x04 /* BAD STA where we are not able to send any packet i.e nFrames it self is Zero */
