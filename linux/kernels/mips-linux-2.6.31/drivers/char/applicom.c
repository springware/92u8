...
/* $Id: //depot/sw/releases/Aquila_9.2.0_U8/linux/kernels/mips-linux-2.6.31/drivers/char/applicom.c#1 $			     */
...
static int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: //depot/sw/releases/Aquila_9.2.0_U8/linux/kernels/mips-linux-2.6.31/drivers/char/applicom.c#1 $\n");
