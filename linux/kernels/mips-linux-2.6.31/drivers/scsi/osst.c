/*
  ...
  $Header: //depot/sw/releases/Aquila_9.2.0_U8/linux/kernels/mips-linux-2.6.31/drivers/scsi/osst.c#1 $
...
static const char * cvsid = "$Id: //depot/sw/releases/Aquila_9.2.0_U8/linux/kernels/mips-linux-2.6.31/drivers/scsi/osst.c#1 $";
